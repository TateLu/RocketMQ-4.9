...
public class ConsumeMessageConcurrentlyService implements ConsumeMessageService {
    ...
    /**
     * <p>sumbit consumeRequest to scheduledExecutorService</p>
     * execute ConsumeRequest in 5 seconds
     * */
    ...
    /**
     *  it's a runnable thread object
     *  execute consumer listener to consume messages
     * */
    class ConsumeRequest implements Runnable {
        ...
        public void run() {
            ...
            /**if the returned  status is null, reconsume these messages later */
            if (null == status) {
