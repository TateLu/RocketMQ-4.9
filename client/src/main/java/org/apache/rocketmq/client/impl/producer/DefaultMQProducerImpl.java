...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    private SendResult sendDefaultImpl(
        ...
        if (topicPublishInfo != null && topicPublishInfo.ok()) {
            ...
            //retry times when failed. default 3 times when communicationMode is SYNC, otherwise 1 time.
            ...
            for (; times < timesTotal; times++) {
                ...
                if (mqSelected != null) {
                    ...
                    try {
                        ...
                        if (times > 0) {
                            /**reset topic with namespace when resend.*/
    ...
    /**
     * @param communicationMode sending mode, sync async oneway
     * @param sendCallback callback listener
     * */
